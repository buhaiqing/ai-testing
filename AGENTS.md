...
| 组件 | 职责 | 技术选型 |
|-----|------|---------|
| **Code Parser** | 源码解析、业务逻辑识别、API 抽取 | LLM + AST Parser (Python/JavaScript/TypeScript) + Code Summarization |
...
**前端框架适配支持**：
- 🟢 **Vue.js** (8.7/10)：SFC单文件组件，Vitest + Vue Test Utils生态成熟
- 🟢 **React.js** (8.3/10)：JSX标准化，Jest + React Testing Library行业标准
- 🟡 **ExtJS** (5.0/10)：遗留系统支持，需自定义解析策略
